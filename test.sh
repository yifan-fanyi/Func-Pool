echo ""
echo -e "\033[34m last update 2020.04.14, some test (..•˘_˘•..)\033[0m"
...
python3 llsr.py
echo -e "\033[92m------- <mylearner.py>\033[0m"
python3 mylearner.py
echo -e "\033[92m------- <lag.py>\033[0m"
python3 lag.py
echo -e "\033[92m------- <hierKMeans.py>\033[0m"
python3 hierKMeans.py 
